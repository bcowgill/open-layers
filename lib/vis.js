...
var oSphMercUK = new OpenLayers.LonLat(oLonLatUK.lon, oLonLatUK.lat);
oSphMercUK.transform(projLonLat, projSphMerc);
console.log("oSphMercUK: ", oSphMercUK);
