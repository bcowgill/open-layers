...
var aCentroids = getCentroidFeatures(CentroidsLatLon);

// Populate features array with centroids
function getCentroidFeatures(aCentroidsLatLon)
{
	...
	for (idx = aCentroidsLatLon.length - 1; idx >= 0; --idx)
	{
		...
		{
			var oPt = new oGeometry.Point(aCentroidsLatLon[idx][LON], aCentroidsLatLon[idx][LAT]),
...
var layerCentroids = new OpenLayers.Layer.Vector(
	"Centroids", {
