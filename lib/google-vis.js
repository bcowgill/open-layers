...
var oMap, oActiveLayer, oHeatMapLayer,
	startZoom = 8, // was 13
...
function changeGradient() {
	...
	oActiveLayer.set('gradient', oActiveLayer.get('gradient') ? null : gradient);
}
...
function changeOpacity() {
	var Opacity = {
		...
		toOpacity = opacity ? (Opacity['' + opacity]|| 0) : Opacity['undefined'];
