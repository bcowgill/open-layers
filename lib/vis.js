...
var DLON = 0, DLAT = 1;
var Delta = [ Nudge[1][DLON] - Nudge[0][DLON], Nudge[1][DLAT] - Nudge[0][DLAT]];
//Delta[DLON] /= 2;
...
function getHeatMapFeatures(oHeatMapInfo, minValue, maxValue)
{
	var idx, value, length,
		...
		color, green, myDelta = [Delta[DLON],Delta[DLAT]];
	console.log("heatmap delta", myDelta);
...
function getStaticIpFeatures(aStaticIpLatLon, minRadius, maxRadius)
{
	...
	console.log("static ip delta", myDelta);
